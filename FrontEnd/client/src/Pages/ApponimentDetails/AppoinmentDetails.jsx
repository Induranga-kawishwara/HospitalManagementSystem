...
//     doc.text(`Patient Name: ${data.patientId}`, 10, 20);
//     doc.text(`Doctor Name: ${data.doctorId}`, 10, 30);
//     doc.text(`Appoinment Date: ${data.doctorId}`, 10, 40);
//     doc.text(`Appoinment Time: ${data.doctorId}`, 10, 50);
//     doc.text(`Specialization : ${data.doctorId}`, 10, 60);
//     doc.text(`Hospital Branch: ${data.doctorId}`, 10, 70);
//     doc.text(`Patient Phone Number: ${data.doctorId}`, 10, 80);
...
//           </div>
//         </div>
//         <button onClick={downloadPdf} type="submit" className={style.buttonpri}>
//           Book Appointment
//         </button>
//         <button
//           type="button"
