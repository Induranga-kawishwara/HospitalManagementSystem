...
//     hospitalBranch: "",
//     department: "",
//     selectedDays: [], // Initialize selectedDays as an empty array
//     workingTimeStart: "",
//     workingTimeEnd: "",
//     workingTimeStartMin: "",
//     workingTimeEndMin: "",
...
//           <FormControl fullWidth variant="filled" sx={{ gridColumn: "span 2" }}>
//             <InputLabel id="workingTimeStartMin">Starting Minute</InputLabel>
//             <Select
//               labelId="workingTimeStartMin"
//               id="workingTimeStartMin"
//               label="workingTimeStartMin"
//               name="workingTimeStartMin"
//               value={formData.workingTimeStartMin}
//               onChange={handleChange}
//             >
//               {Array.from(Array(60).keys()).map((hour) => (
//                 <MenuItem key={hour} value={hour + 1}>
...
//               label="workingTimeEndMin"
//               name="workingTimeEndMin"
//               value={formData.workingTimeEndMin}
//               onChange={handleChange}
//             >
//               {Array.from(Array(60).keys()).map((hour) => (
//                 <MenuItem key={hour} value={hour + 1}>
